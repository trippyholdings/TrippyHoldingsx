...
export const siteData = {
  ...
  projects: [
    ...
    {
      variant: "showcase",
      title: "Raid Boss Framework",
      header: "Boss & Encounter System",
      headline: "Reusable encounter loop with phases, telegraphs, and anti-cheat hooks.",
      media: [
        { type: "image", src: "https://media.discordapp.net/attachments/1374068118883668110/1460000000000000000/raid-boss.png?format=webp&quality=lossless" },
        { type: "video", src: "https://www.youtube.com/watch?v=8Z8WcWJQIl8" },
      ],
      summary: "Composable boss framework: phases, telegraphs, AOEs, and rewards tied into DataStore/ProfileStore.",
      details:
        "Built a server-authoritative boss framework with configurable phases, damage windows, tell animations, and reward rolls. Includes exploit-resistant hit registration, wipe timers, and analytics hooks for balancing.",
    },
    {
      variant: "project",
      title: "Neon Drift",
    ...
    },
    {
      ...
      header: "Frontier Defense",
      headline: "Co-op wave defense with scalable difficulty and loot progression.",
      media: [
        { type: "video", src: "https://www.youtube.com/watch?v=Jk8LnWFNQn0" },
        { type: "image", src: "https://media.discordapp.net/attachments/1374068118883668110/1460000000000000001/frontier-defense.png?format=webp&quality=lossless" },
      ],
      summary: "Team up against scaling waves, earn loot, and unlock new kits.",
      details:
        "Engineered wave scaling, matchmaking, drop tables, and kit progression. Added anti-afk/anti-exploit checks, map voting, and live balance toggles to keep sessions fair and replayable.",
      link: "https://www.roblox.com/games/12223334444/Frontier-Defense",
    },
    {
      variant: "project",
      title: "Arcane Arena",
    ...
    },
    {
      ...
      summary: "Reference card showing the fields needed: title, header, headline, media, summary, details, and optional link.",
      details:
      ...
      link: "https://www.roblox.com/games/<GAME_ID>/Your-Game-Name",
      isTemplate: true,
    },
  ] as ProjectItem[],
  contact: {
